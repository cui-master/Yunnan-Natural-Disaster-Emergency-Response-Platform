...
BACKEND_W=$(cygpath -w "/f/shixun(gaoji)/云南自然灾害应急协同决策平台/DAY-2/Yunnan-Natural-Disaster-Emergency-Response-Platform-main/backend")

cd "/f/shixun(gaoji)/云南自然灾害应急协同决策平台/DAY-2/Yunnan-Natural-Disaster-Emergency-Response-Platform-main/backend"
unset SERVER__PORT
