-- ============================================================
-- 云南省自然灾害应急响应平台 - 增量建表脚本（安全版）
-- 数据库: emergency_auth
-- 特点: 使用 CREATE TABLE IF NOT EXISTS，不 DROP 任何表，安全可重复执行
-- 用途: 补建缺失的业务表（incidents、resources 等）
-- ============================================================

USE emergency_auth;

-- ============================================================
-- 1. 位置表 locations（如果没有就建）
-- ============================================================
